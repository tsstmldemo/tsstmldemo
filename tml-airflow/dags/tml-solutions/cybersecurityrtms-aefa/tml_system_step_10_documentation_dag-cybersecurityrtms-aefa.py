...
default_args = {    
 ...
 step4clocalsearchtermfolderinterval=60***step4crtmsfoldername=rtms2', # add any environmental variables for docker must be: variable1=value1***variable2=value2
