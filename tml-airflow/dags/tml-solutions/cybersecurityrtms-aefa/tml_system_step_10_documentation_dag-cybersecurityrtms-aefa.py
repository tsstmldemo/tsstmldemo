...
default_args = {    
 ...
 step9pgptcontainername=maadsdocker/tml-privategpt-with-gpu-nvidia-amd64-v2***step9contextwindow=8192***step9vectordimension=784***\
 step9temperature=0.1', # add any environmental variables for docker must be: variable1=value1***variable2=value2
