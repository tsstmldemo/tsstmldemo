...
default_args = {
  ...
  'producerid' : '',   # <<< *** Change as needed   
  'raw_data_topic' : '', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'preprocess_data_topic' : '', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  ...
  'preprocesstypes' : 'raw,trend', # <<< **** MAIN PREPROCESS TYPES CHNAGE AS NEEDED refer to https://tml-readthedocs.readthedocs.io/en/latest/
  'pathtotmlattrs' : 'oem=n/a,lat=n/a,long=n/a,location=n/a,identifier=n/a', # Change as needed     
  'jsoncriteria' : 'uid=Topic,filter:allrecords~\
subtopics=hyperpredictionrawtechnique,technique,technique~\
